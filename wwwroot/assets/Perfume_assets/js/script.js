...
if (theme) {
    if (theme == "dark") {
        $('.dark-btn').html(`<img src="/assets/Perfume_assets/svg/moon-solid.svg" width="15"/>`);
        $('body').addClass('dark');
    } else {
        $('#theme-dark').remove();
        $('.dark-btn').html(`<img src="/assets/Perfume_assets/svg/sun-solid.svg" width="15"/>`);
