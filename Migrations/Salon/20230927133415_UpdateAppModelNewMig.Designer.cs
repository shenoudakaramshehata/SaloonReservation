...
namespace SaloonReservation.Migrations.Salon
{
    ...
    [Migration("20230927133415_UpdateAppModelNewMig")]
    partial class UpdateAppModelNewMig
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SaloonReservation.Models.Appointment", b =>
                {
                    ...
                    b.Property<string>("FattorahPaymentId")
            ...
            modelBuilder.Entity("SaloonReservation.Models.ContactUs", b =>
                {
            ...
            modelBuilder.Entity("SaloonReservation.Models.Country", b =>
                {
                    b.Property<int>("CountryId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SaloonReservation.Models.PageContent", b =>
                {
            ...
            modelBuilder.Entity("SaloonReservation.Models.PublicSlider", b =>
                {
            ...
            modelBuilder.Entity("SaloonReservation.Models.SoicialMidiaLink", b =>
                {
                    b.Property<int>("SoicialMidiaLinkId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("SoicialMidiaLinkId"));
            ...
            modelBuilder.Entity("SaloonReservation.Models.TemporaryAppointment", b =>
                {
                    b.Property<int>("TemporaryAppointmentId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("TemporaryAppointmentId"));
                    ...
                    b.HasKey("TemporaryAppointmentId");

                    b.ToTable("TemporaryAppointments");
                });

            modelBuilder.Entity("SaloonReservation.Models.TemporaryAppointmentService", b =>
                {
                    b.Property<int>("TemporaryAppointmentServiceId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("TemporaryAppointmentServiceId"));
                    ...
                    b.HasKey("TemporaryAppointmentServiceId");

                    b.HasIndex("TemporaryAppointmentId");

                    b.ToTable("TemporaryAppointmentServices");
                });
            ...
            modelBuilder.Entity("SaloonReservation.Models.City", b =>
                {
                    b.HasOne("SaloonReservation.Models.Country", "Country")
                        .WithMany("City")
            ...
            modelBuilder.Entity("SaloonReservation.Models.TemporaryAppointmentService", b =>
                {
                    b.HasOne("SaloonReservation.Models.TemporaryAppointment", null)
                        .WithMany("TemporaryAppointmentServices")
                        .HasForeignKey("TemporaryAppointmentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("SaloonReservation.Models.TemporaryAppointment", b =>
                {
                    b.Navigation("TemporaryAppointmentServices");
                });
