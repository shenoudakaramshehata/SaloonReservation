...
{
	public class FattorahFailedModel : PageModel
	{
        ...
        public FattorahFailedModel(IRazorPartialToStringRenderer renderer, SalonContext context, IEmailSender emailSender, IHostingEnvironment env, IConfiguration configuration)
        {
            _context = context;
